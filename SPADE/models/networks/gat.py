...
class GraphAttention(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, feat_drop, attn_drop,
...
class GAT(nn.Module):
    def __init__(self, num_layers, in_dim, num_classes, num_hidden, heads, activation, final_activation, feat_drop,
        ...
        self.layers.append(GraphAttention(in_dim=in_dim,
        ...
        for l in range(1, num_layers - 1):
            ...
            lyr = GraphAttention(in_dim=num_hidden[l - 1] * heads[l - 1],
        ...
        # output projection
        self.layers.append(GraphAttention(in_dim=num_hidden[-1] * heads[-1],
                                          out_dim=num_classes,
                                          num_heads=1,
                                          feat_drop=feat_drop,
                                          attn_drop=attn_drop,
